            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_update_input" placeholder="hk520@qq.com">
...
<div class="modal fade" id="empAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">email</label>
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_add_input" placeholder="hk520@qq.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function getDepts(ele) {
            ...
            $.ajax({
               ...
               success:function (result) {
                   // {code: 100, msg: "处理成功！",…}
                   // code: 100
                   // extend: {depts: [{deptId: 7, deptName: "开发部"}, {deptId: 8, deptName: "测试部"}]}
                    // depts: [{deptId: 7, deptName: "开发部"}, {deptId: 8, deptName: "测试部"}]
                     // 0: {deptId: 7, deptName: "开发部"}
                        // deptId: 7
                        // deptName: "开发部"
                     // 1: {deptId: 8, deptName: "测试部"}
                        // deptId: 8
                        // deptName: "测试部"
                     // msg: "处理成功！"
                   // console.log(result)
        ...
        function show_validate_msg(ele,status,msg){
            //清除当前元素的校验状态
            $(ele).parent().remove("has-error has-success");
            $(ele).next("span").text("");
            if ("success" == status){
        ...
        $("#check_all").click(function () {
            //attr获取checked时，是undefined
            //我们dom这些原生的属性;attr获取自定义属性的值；
            //prop修改和读取dom原生属性的值
            // $(this).prop("checked");
            //全选/全不选
